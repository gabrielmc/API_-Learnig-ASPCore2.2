using Atividade_Garagem.Business.implementacoes;
using Atividade_Garagem.Business.interfaces;
using Atividade_Garagem.Context;
using Atividade_Garagem.Repository.implementacoes;
...
namespace Atividade_Garagem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ExemploContext>(options => options.UseSqlServer(connectionString));

            services.AddScoped(typeof(IGenericRepository<>), typeof(GenericRepository<>));
            services.AddScoped<IClienteBusiness, ClienteBusiness>();
            services.AddScoped<IServicoBusiness, ServicoBusiness>();
